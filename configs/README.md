...
- `micro_alpha_selected_quality.json`: SPY/QQQ/IWM market-making quality-gate configuration behind `hft_microstructure/Results/micro_alpha_quality_sharpe_report.md`.
