...
- `Results/micro_alpha_statistical_diagnostics.csv`, `Results/micro_alpha_walk_forward_folds.csv`, `Results/micro_alpha_research_quality_scorecard.csv`, and `Results/micro_alpha_research_quality_report.md`: final no-new-data research hardening with PSR/sign-flip sanity checks, three chronological folds, and explicit pass/warn/fail gates.
...
- `Plots/hft_micro_alpha_research_quality.png`: final research-quality gate counts, chronological fold stability, and statistical sanity checks.
